#
# Train ResNet on cifar10 dataset with lr decay
# a : zhonghy
# date: 2018-9-12
#
...
def poly_decay(epoch):
    ...
    # and power of the polynominal
    maxEpochs = NUM_EPOCHS
    baseLR = INIT_LR
    power = 1.0

    # comput the new learning rate based on polynomial decay
...
# construc the image generator for data augmentation
...
# if there is no specific model checkpoint supplied, the initialize
...
model.fit_generator(
    aug.flow(trainX, trainY, batch_size=32),  # 128
    validation_data=(testX, testY),
    steps_per_epoch=len(trainX) // 32, epochs=50, # 10
