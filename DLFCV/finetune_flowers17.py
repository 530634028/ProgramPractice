#
# Fine-tuning, from Start to Finish, on 17flowers dataset
# a : zhonghy
# date: 2018-8-22
#
...
# place the head FC model on the top of the base model -- this will
...
# batch_size is too large to training, so go home for training