...
class DeeperGoogLeNet:
    ...
    def inception_module(x, num1x1, num3x3Reduce, num3x3,
        ...
        # define the second branch of Inception module which
        ...
        # define the third branch of Inception module which
        ...
        # define the fourth branch of Inception module which
    ...
    def build(width, height, depth, classes, reg=0.0005):
        ...
        # applay two Inception modules followed by a POOL
        ...
        # applay five Inception modules followed by POOL
