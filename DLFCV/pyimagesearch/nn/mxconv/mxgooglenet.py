"""
#
# Implement of GoogleNet using mxnet library
# a : zhonghy
# date: 2018-12-4
#
"""
...
class MxGoogleNet:
    ...
    def inception_module(data, num1x1, num3x3Reduce, num3x3,
        ...
        # the first branch of the Inception module consits of 1x1
        # convolutions
        ...
        # thr third branch of the Inception module is a set of 1x1
    ...
    def build(classes):
        ...
        in5b = MxGoogleNet.inception_module(in5a, 384, 192, 384, 48,
                                            128, 128)
        pool5 = mx.sym.Pooling(data=in5b, pool_type="max",
                               pad=(1, 1), kernel=(3, 3), stride=(2, 2))
