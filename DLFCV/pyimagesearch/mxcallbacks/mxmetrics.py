"""
 implement of one accuracy for age and gender classification
 a : zhonghy
 date: 2019-1-15
...
def one_off_callback(trainIter, testIter, oneOff, ctx):
    def _callback(iterNum, sym, arg, aux):
        # construct a model for the symbol so we can make predications
        # on our data
...
def _compute_one_off(model, dataIter, oneOff):
    ...
    # loop over the prediction of batches
