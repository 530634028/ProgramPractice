...
from pyimagesearch.nn.mxconv.mxvggnet16 import MxVGG16Net
import mxnet as mx
import argparse
import logging
import json
...
if args["start_epoch"] <= 0:
    ...
    model = MxVGG16Net.build(config.NUM_CLASSES)
...
model = mx.model.FeedForward(
    ctx=[mx.gpu(i) for i in range(0, config.NUM_DEVICES)], # by your need
    symbol=model,
...
# python train_vggnet.py --checkpoints checkpoints --prefix alexnet
