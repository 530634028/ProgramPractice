#
# Building Tiny ImageNet and converting it to HDF5
# a : zhonghy
# date: 2018-9-5
#
...
# load the validation filename => class from file and then us these
...
# construct a dictionary of average, then serialize the means to a
# JSON file
