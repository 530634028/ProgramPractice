...
# define the paths to the WordNet directory files which are used
...
# HDF5 files
TRAIN_HDF5 = "../../../data/tiny-imagenet-200/hdf5/train.hdf5"
VAL_HDF5 = "../../../data/tiny-imagenet-200/hdf5/val.hdf5"
TEST_HDF5 = "../../../data/tiny-imagenet-200/hdf5/test.hdf5"
...
MODEL_PATH = path.sep.join([OUTPUT_PATH,
                            "checkpoints/resnet_tinyimagenet.hdf5"])
