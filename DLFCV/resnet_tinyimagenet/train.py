#
# Train ResNet on tiny_imagenet dataset without lr decay
# a : zhonghy
# date: 2018-9-12
#
...
model.fit_generator(
    trainGen.generator(),
    steps_per_epoch=trainGen.numImages // 16, # 64
    validation_data=valGen.generator(),
    validation_steps=valGen.numImages // 16,  # 64
    epochs=50,
    max_queue_size=16 * 2,  # 64
    callbacks=callbacks,
    verbose=1
)
