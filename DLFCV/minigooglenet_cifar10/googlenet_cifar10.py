#
# Train minigooglienet on cifar10 dataset
# a : zhonghy
# date: 2018-9-5
#
...
def poly_decay(epoch):
    # initialize max epochs, base lr, and power of polynomial
    maxEpochs = NUM_EPOCHS
    baseLR = INIT_LR
    power = 1.0

    # compute the new lr based on polynomial decay
...
# load training and testing data, converting images from
# integers to floats
