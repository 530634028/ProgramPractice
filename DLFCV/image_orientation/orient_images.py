...
# load the label names (i.e., angles) from HDF5 dataset
...
for imagePath in imagePaths:
    ...
    # pass the image through the network to obtain the features
    ...
    # now that we have the predicted orientation of the image
    # correct for it
