#
# Implement of SGD(Stochastic Gradient Descent)
# a: zhonghy
# date: 2018-7-5
#
#
...
def predict(X, W):
    # take the dot product between our features and wight matrix
...
(trainX, testX, trainY, testY) = train_test_split(X, y,
               ...
               #wrong write trainY to trainX, so there two trainX
...
plt.title("Data")
print(testY[:, 0])
plt.scatter(testX[:, 0], testX[:, 1], marker="o", c=testY[:, 0], s=10) #?
